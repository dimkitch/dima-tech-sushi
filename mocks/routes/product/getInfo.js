  ...
  result: [
    {
      ...
      qualitiCertificate: {
        ...
        features: [
          ...
          },
          {
            id: 3,
            image:
              "https://bizprinting.ru/image/catalog/products/full_11221.jpg",
          },
          {
            id: 4,
      ...
      customerFeedback: {
        title: "Почитайте отзывы довольных клиентов",
        customerCard: [
          {
            id: 1,
...
module.exports = [
  {
    id: "product-get-info", // id of the route
    url: "/product/getInfo",
    method: "GET",
    variants: [
      {
